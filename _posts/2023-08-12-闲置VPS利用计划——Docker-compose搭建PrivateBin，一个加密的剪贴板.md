...
tags: 
    ...
    - 💻闲置VPS利用计划
author: yuniee
featuredimg: https://s2.loli.net/2023/08/16/kmBTW3Uh8be6SH4.png
...
如果想要配置反向代理使用域名访问网页，请参考这篇文章： [Caddy的基础使用，下载Caddy并部署反向代理和自动签发, 续期SSL 证书](https://www.yuniee.de/2023/07/30/caddy的基础使用-下载caddy并部署反向代理和自动签发-续期ssl-证书/)
    
在PrivateBin配置文件中配置yourls短链接请看这篇：
